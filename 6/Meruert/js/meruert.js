...
var getMeruertJS = function() {
	...
	walkAround('a', 'attached_image_link', function(){
		_elem.onclick = function() {
			...
			shadowZone.setAttribute('style','width:100%; height:100%; position:absolute; left:0; top:'+getTop+'px; background:#000; opacity:0.99; z-index:25000;');
			shadowZone.setAttribute('id','shadowZone');
			body.appendChild(shadowZone);
			var imgZone = document.createElement('div');
			imgZone.setAttribute('style','width:100%; height:100%; position:absolute; left:0; top:'+getTop+'px; background:url('+getImage+') no-repeat center center; z-index:30000;');
			...
			xZone.setAttribute('style','position:absolute; right:50px; top:40px; z-index:32000; font-size:30pt; font-weight:bold; color:#fff; cursor:pointer;');
			...
			lnkZone.setAttribute('style','position:absolute; left:50px; top:55px; z-index:32000; font-size:10pt; color:#fff;');
			...
			if(getLargeImage!=localImageSet[0]) {
				...
				leftArrowZone.setAttribute('style','position:absolute; left:50px; top:40%; z-index:32000; font-size:24pt; font-weight:bold; color:#ccc; cursor:pointer; font-family:Monospace;');
			...
			if(getLargeImage!=localImageSet[localImageLast]) {
				...
				rightArrowZone.setAttribute('style','position:absolute; right:50px; top:40%; z-index:32000; font-size:24pt; font-weight:bold; color:#ccc; cursor:pointer; font-family:Monospace;');
	...
	topLinkBlock.setAttribute('style','width:30px; height:30px; position:fixed; right:75px; bottom:75px; background:#000; opacity:0.5; z-index:20000; border-radius:3px; color:#fff; text-align:center; line-height:28px; font-size:12pt; cursor:pointer; display:none;');
