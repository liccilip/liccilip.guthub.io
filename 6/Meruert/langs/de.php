...
Copy this page = kopieren Sie die Seite

(edit part) = (Fragment bearbeiten)
(edit) = (bearbeiten)
Editing part = Fragment bearbeiten
Insert stats code = Einfügen den Kode der Statistik
stats code = Kode der Statistik
...
Email = E-Mail
Check your mailbox. = Überprüfen Sie Ihre E-Mail.
: password reminder = : Passworterinnerung
Your password: = Ihr Passwort:
Send notifications to the following email: = Senden Sie Mitteilungen an die folgende E-Mail:

allow comments for this entry = Kommentare zu dieser Artikel ermöglichen
make this entry visible for everyone = machen die Artikel für alle sichtbar
closed website = geschlossen Website
Editing meta = Metadaten
Alternative URL = Alternative URL
Alternative heading = Alternative Überschrift
Preface = Vorwort
Alternative title = Alternative TITLE
Keywords = Stichwörter
Description = Beschreibung
Deferred post = Verzögerte Artikel
Create new folder = Erstellen eines neuen Ordners
display only content in the selected language = nur Artikel in der gewählten Sprache zeigen
Post language: = Sprache für den Eintrag:
post ratings = Bewertungen
Ratings = Bewertungen
...
Editing menu = Menü bearbeiten
log = Ereignisprotokoll
Log = Ereignisprotokoll

(edit PHP code) = (PHP-Kode bearbeiten)
PHP code = PHP-Kode



Edit the super menu =  Hauptmenü bearbeiten
only positive ratings = Nur positive Bewertungen
hide Favourite link = den Link zu den vorgestellten Artikel verstecken
hide Secret posts link = den Link zu den geheime Artikel verstecken
hide Drafts link = den Link zu den Skizzen verstecken  
hide Files link = den Link zu den Dateien verstecken
hide Comments link = den Link zu den Kommentare verstecken
hide Ratings link = den Link zu den Bewertungen verstecken

hide topic list = die Liste der Themen verbergen

Create new file = Erstellen Sie eine neue Datei
MB = MB

Publish in = Erscheinungsort
main blog = Haupt-Blog
add a blog = einem Blog hinzufügen
New blog title = Der Name des neuen Blog
blogs in sidebar = Blog-Namen in der Seitenleiste
blogs = Blogs
topics = Themen
Name = Der Name
search in sidebar = Suche in der Seitenleiste

edit Meta = Meta bearbeiten
Edit Meta = Meta  bearbeiten
Motto: = Slogan:
Confirm, please! = Bitte bestätigen!
Reset the preferences = Zurücksetzen

Nickname / name: = Ihr Name oder Nickname:
E-mail: = E-mail:
Message: = Mitteilung:
Message from your website = Brief von Ihrer Website
Message sent. = Mitteilung wurde gesendet.

Cancel = Abbrechen
make main page = Startseite

Click to enlarge = Klicken zum Vergrößern

Record order: = Die Reihenfolge der Artikel:
usual = üblich
from beginning = von Anfang
random = zufällig
alphabetical = alphabetisch
anti-alphabetical = anti-alphabetisch
by rating = nach Bewertung

Pagination: = Paginierung:
under the posts = nach den Artikeln
over and under the posts = über und unter Artikel
concise = lakonisch
none = kein
previous = vorherige
next = nächste
