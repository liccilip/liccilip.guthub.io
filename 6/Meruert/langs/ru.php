...
Copy this page = Копировать эту страницу

(edit part) = (править фрагмент)
(edit) = (ред.)
Editing part = Редактирование фрагмента
Insert stats code = Вставить код статистики
...
Email = E-mail
Check your mailbox. = Проверьте электронную почту.
: password reminder = : напоминание пароля
Your password: = Ваш пароль:
Send notifications to the following email: = Отправлять уведомления на следующий e-mail:

allow comments for this entry = разрешить комментарии для этой записи
make this entry visible for everyone = сделать эту запись видимой для всех
closed website = закрытый сайт
Editing meta = Мета-данные
Alternative URL = Альтернативный URL
Alternative heading = Альтернативный заголовок
Preface = Предисловие
Alternative title = Альтернативный TITLE
Keywords = Ключевые слова
Description = Описание
Deferred post = Отложенная запись
Create new folder = Создать новую папку
display only content in the selected language = отображать только контент на выбранном языке
Post language: = Язык записи:
post ratings = рейтинги записей
Ratings = Рейтинги

Create = Создать
create = создать
change = изменить
(edit menu) = (править меню)
...
(edit PHP code) = (править PHP-код)
PHP code = PHP-код

Edit the super menu = Редактирование главного меню
only positive ratings = только положительные рейтинги
hide Favourite link = скрывать ссылку на избранное
hide Secret posts link = скрывать ссылку на тайные записи
hide Drafts link = скрывать ссылку на черновики
hide Files link = скрывать ссылку на файлы
hide Comments link = скрывать ссылку на комментарии
hide Ratings link = скрывать ссылку на рейтинги

hide topic list = скрывать список тем

Create new file = Создать новый файл
MB = МБ

Publish in = Место публикации
main blog = основной блог
add a blog = добавить блог
New blog title = Название нового блога
blogs in sidebar = названия блогов в боковой колонке
blogs = блоги
topics = темы записей
Name = Название
search in sidebar = поиск в боковой колонке

edit Meta = Meta-тэги
Edit Meta = Meta-тэги
Motto: = Слоган:
Confirm, please! = Подтвердите, пожалуйста!
Reset the preferences = Сбросить настройки

Nickname / name: = Имя или ник:
E-mail: = Электронный адрес:
Message: = Сообщение:
Message from your website = Письмо с вашего сайта
Message sent. = Сообщение отправлено.

Cancel = Отмена
make main page = сделать главной страницей сайта

Click to enlarge = Щёлкните, чтобы увеличить

Record order: = Порядок записей:
usual = обычный
from beginning = с начала времён
random = случайный
alphabetical = алфавитный
anti-alphabetical = антиалфавитный
by rating = по рейтингу

Pagination: = Нумерация страниц:
under the posts = под записями
over and under the posts = над и под записями
concise = лаконичная
none = отсутствует
previous = предыдущая
next = следующая
